...
/**
 * @brief Macro che restituisce il puntatore all'istanza della struttura che
 * contiene un certo list_head. Per farlo usa il puntatore al list_head, il
 * tipo della struttura che lo contiene e il nome dato al campo che contiene
 * la lista.
 ...
 *     il puntatore
 * type: tipo della struttura che contiene list_head e di cui si vuole
 *       ottenere un puntatore member: nome della variabile di tipo list_head
 *       contenuta come campo nella struttura
 *
...
/**
 * @brief Macro che restituisce l'offset in byte dall'inizio di una struttura a
 *   uno dei suoi campi.
...
/**
 * @brief La struttura list_head e' una semplice coppia di puntatore, per
 * implementare una lista bidirezionale. Per creare liste di strutture
 * arbitrarie basta inserire al loro interno un campo di tipo list_head.
 */
struct list_head {
...
/**
 * @brief Macro che definisce una lista vuota, inizializzando una list_head con
...
/**
 * @brief Macro che dichiara e inizializza una nuova lista. Rispetto alla macro
...
/**
 * @brief Funzione inline che inizializza la lista list come vuota (entrambi i
 * campi che puntano a se stessa). Mentre LIST_HEAD_INIT crea una struttura
 * anonima da assegnare a una variabile, INIT_LIST_HEAD inizializza i campi di
 * una struttura gia' esistente.
 *
...
/**
 * @brief Funzione che inserisce un nuovo elemento (new) tra prev e next
 *
...
/**
 * @brief Funzione che inserisce un nuovo elemento (new) in testa alla lista
 * head.
 *
 *   new: nuovo elemento da inserire
...
/**
 * @brief Come list_add, ma inserisce l'elemento new in coda
 *
 *   new: nuovo elemento da inserire
 *   head: lista in cui inserire new
 *
...
/**
 * @brief Rimuove gli elementi compresi tra prev e next, collegandoli
 * direttamente.
 *
...
/**
 * @brief Rimuove l'elemento entry dalla lista in cui e' contenuto.
 * off
...
/**
 * @brief Funzione che controlla se la lista e' arrivata alla fine
 *
...
/**
 * @brief Funzione che controlla se la lista head e' vuota.
 *
...
/**
 * @brief   Funzione che restituisce l'elemento successivo a quello passato come
 *    parametro.
 *
...
/**
 * @brief   Funzione che restituisce l'elemento precedente a quello passato come
 *    parametro.
 *
...
/**
 * @brief Macro che costruisce un ciclo for per iterare su ogni elemento della
 * lista che ha inizio in head. La variabile pos punta al campo struct list_head
 * della lista.
...
/**
 * @brief Macro analoga a list_for_each ma che procede a ritroso.
 *
 * pos: puntatore da utilizzare per iterare sugli elementi
 * head: inizio della lista (elemento sentinella)
 */
...
/**
 * @brief Macro che costruisce un ciclo for per iterare sul contenuto di una
 * lista; l'unica differenza dispetto a list_for_each e' che la variabile pos
 * punta alla struttura che contiene il campo member anziche' al campo stesso.
 *
...
/**
 * @brief Macro analoga a list_for_each_entry ma che procede a ritroso
 *
 *   pos: puntatore da utilizzare per iterare sul contenuto della lista
 *   head: inizio della lista (elemento sentinella)
 *   member: nome del campo contenente la list_head
